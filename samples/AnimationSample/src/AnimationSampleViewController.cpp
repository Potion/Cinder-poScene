...
AnimationSampleViewControllerRef AnimationSampleViewController::create() 
{
    AnimationSampleViewControllerRef ref(new AnimationSampleViewController());
    ref->setup();
    return ref;
}

void AnimationSampleViewController::setup() 
{
	...
	getView()->addSubview(mPositionSquare);
	...
	getView()->addSubview(mScaleSquare);
	...
	getView()->addSubview(mAlphaSquare);
	...
	getView()->addSubview(mRotationSquare);
    ...
    getView()->addSubview(mOffsetSquare);
	...
	getView()->addSubview(mColorSquare);
}
