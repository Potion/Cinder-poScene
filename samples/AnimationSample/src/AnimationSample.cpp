...
void AnimationSample::setup() 
{
    ...
    mPositionSquare->setPosition(ci::Vec2f(xOffset, yOffset));
    ...
    mScaleSquare->setPosition(ci::Vec2f(xInterval + xOffset, yOffset));
    ...
    mAlphaSquare->setPosition(ci::Vec2f((xInterval * 2) + xOffset, yOffset));
    ...
    mRotationSquare->setPosition(ci::Vec2f((xInterval * 3) + xOffset, yOffset));
    ...
    mOffsetSquare->setPosition(ci::Vec2f((xInterval * 4) + xOffset, yOffset));
    ...
    mColorSquare->setPosition(ci::Vec2f((xInterval * 5) + xOffset, yOffset));
